...
def is_inertial(arr):
    ...
    all_odd = [num for num in arr if num%2 != 0]
    all_even = [num for num in arr if num != max_value and num%2 == 0]
...
print(is_inertial([1])) # return 0
print(is_inertial([2])) # return 0
print(is_inertial([1,2,3,4])) # return 0
print(is_inertial([1,1,1,1,1,1,2])) # return 1
print(is_inertial([2,12,4,6,8,11])) # return 1
print(is_inertial([2,12,12,4,6,8,11])) # return 1
print(is_inertial([-2,-4,-6,-8,-11])) # return 0
print(is_inertial([2,3,5,7])) # return 0
print(is_inertial([2,4,6,8,10])) # return 0
